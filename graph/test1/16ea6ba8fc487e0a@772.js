let chart = function (tree, bilink, d3, data, width, id, path, k, color) {
...
let data = async function (hierarchy, FileAttachment) {
    return (
...
let Path = function (Line, BezierCurve) {
    return (
        class Path {
            constructor(_) {
                this._ = _;
